...
class Index extends CI_Controller
{
    ...
    function register()
    {
		...
		// $maha_cities['cities']=$this->Cities_model->getall_cities('$');
...
//                                 die;
                            ...
                            {
                                $this->center_registration_mail_to_admin($mail->user_email,$get_data,$get_insert);
                            }
                               if($result==true)
                                {
...
//                   
   ...
   function center_registration_mail_to_admin($user_email,$center_data,$id)
    {
       ...
       $headers = "From: team@webosys.com";
                    ...
                    $txt = '<html><body>
                           <span>Dear Delto,</span><br><br> 
                            ...
                            <span>Center City: '.$city->cityName.'</span><br>    
