  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box" style="background:#16b9de">
            <div class="inner">
              <h3> <?php if(isset($students))
              {
            ...
            <a href="<?php echo base_url(); ?>center/Dashboard" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
