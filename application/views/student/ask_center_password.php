...
<body>
            <form class="modal fade" id="myModal" role="dialog" action="<?php echo base_url(); ?>student/Index/check_center_password" method="post">
    ...
    <strong>Error!</strong> <?php echo $error; ?> 
        ...
        <?php }?>    
            ...
            <a href="<?php echo  base_url();?>student/index" name="cancel" class="btn btn-danger">Cancel</a>
        </div>
                         </div>
